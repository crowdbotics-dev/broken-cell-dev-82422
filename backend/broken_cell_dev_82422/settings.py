"""
Django settings for broken_cell_dev_82422 project.
...
ROOT_URLCONF = 'broken_cell_dev_82422.urls'
...
WSGI_APPLICATION = 'broken_cell_dev_82422.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_cell_dev_82422 API",
    "DESCRIPTION": "API documentation for broken_cell_dev_82422 App",
    "VERSION": "v1",
}
